...
<html>
    <head>
        <title><s:message code="estadosPersonasForm.titulo" /></title>
    </head>
    <body>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <s:message code="estadosPersonasForm.panel" />
                    </h3>
                </div>
                <div class="card-body">
                    <c:url var='guardar' value='/estadosPersonas/guardar'></c:url>
                    <form:form method="POST" modelAttribute="estadosPersonas"
                               action="${guardar}" >
                        <form:input type="hidden" path="id" />
                        <div class="myrow">
                            <div class="form-group">
                                <div class="row row-center">
                                    <s:message code='estadosPersonasForm.Descripcion.placeholder' var='var1' />
                                    <s:message code='sistema.form.completar.tooltip' var='var2' />
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                        <label class="form-tittle label-required" for="descripcion">
                                            <s:message
                                                code="estadosPersonasForm.descripcion" /></label>
                                    </div>
                                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                                        <form:input  onkeyup="toUpper(this)" maxlength="100" type="text" path="descripcion" id="descripcion"
                        ...
                        <div class="myrow float-right">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <a data-toggle="tooltip" data-placement="bottom" title="<s:message code="sistema.btnCancelar.tooltip" />" href="<c:url value='/estadosPersonas/lista' />"><button
