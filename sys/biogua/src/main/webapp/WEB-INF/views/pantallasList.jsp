...
<%-- 
    Document   : pantallasList
    Created on : 12/07/2018, 13:02:10
    Author     : jacosta
--%>
<html>
    <head>
        <title><s:message code="pantallasList.titulo" /></title>
    </head>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <s:message code="pantallasList.panel"/>
                    </h3>
                </div>
                <div class="card-body">    
                    <div class="myrow" >
                        <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                            <a data-toggle="tooltip" data-placement="left" title="<s:message code="sistema.btnNuevo.tooltip"/>" class="btn btn-info margin-btn"
                               href="<c:url value='/pantallas/nuevo'/>">
                                <span  class="fa fa-plus-square"></span>
                                <s:message code="sistema.form.btnNuevo" />
                            </a>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8" >
                            <c:url var='path' value='/pantallas'></c:url>                              
