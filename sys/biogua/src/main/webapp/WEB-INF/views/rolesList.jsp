...
<%-- 
    Document   : rolessList
    Created on : 25/07/2018, 18:44:10
    Author     : jacosta
--%>
<html>
    <head>
        <title><s:message code="rolesList.titulo" /></title>
    </head>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <s:message code="rolesList.panel"/>
                    </h3>
                </div>
                <div class="card-body">    
                    <div class="myrow" >
                        <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                            <a data-toggle="tooltip" data-placement="left" title="<s:message code="sistema.btnNuevo.tooltip"/>" class="btn btn-info margin-btn"
                               href="<c:url value='/roles/nuevo'/>">
                                <span  class="fa fa-plus-square"></span>
                                <s:message code="sistema.form.btnNuevo" />
                            </a>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8" >
                            <c:url var='path' value='/roles'></c:url>                              
                    ...
                    <div class="myrow scrollHorizontal" >
                        <table border='1' cellpadding='1' cellspacing='1'
                            ...
                            <tr class="w3-light-grey">
                                <th><s:message code="rolesList.grilla.descripcion" /></th>
                            ...
                            <c:forEach items="${lista}" var="l">
                                <tr >
                                    ...
                                    <td class="td-center">
                                        <a href="<c:url value='/rolesPantallas/pantallasDelRol/${l.id}'></c:url>">
