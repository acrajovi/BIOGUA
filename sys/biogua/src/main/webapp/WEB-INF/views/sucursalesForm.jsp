...
<html>
    <head>
        <title><s:message code="sucursalesForm.titulo" /></title>
    </head>
    <body>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <s:message code="sucursalesForm.panel" />
                    </h3>
                </div>
                <div class="card-body">
                    <c:url var='guardar' value='/sucursales/guardar'></c:url>
                    <form:form method="POST" modelAttribute="sucursales"
                               action="${guardar}" >
                        <form:input type="hidden" path="id" />
                        <div class="myrow">
                            <div class="form-group">
                                <div class="row row-center">
                                    <s:message code='sucursalesForm.Descripcion.placeholder' var='var1' />
                                    <s:message code='sistema.form.completar.tooltip' var='var2' />
                                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-3">
                                        <label class="form-tittle label-required" for="descripcion">
                                            <s:message code="sucursalesForm.descripcion" /></label>
                                    </div>
                        ...
                        <div class="myrow float-right">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <a data-toggle="tooltip" data-placement="bottom" title="<s:message code="sistema.btnCancelar.tooltip"/>" href="<c:url value='/sucursales/lista' />"><button
