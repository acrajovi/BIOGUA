...
(function ($) {
    ...
    $.sessionTimeout = function (options) {
        var defaults = {
            title: 'Tiempo de inactividad máxima alacanzada!',
            message: 'No se ha detectado actividad del usuario.',
            logoutButton: 'Cerrar sesión',
            keepAliveButton: 'Menú Principal',
        ...
        if (typeof opt.onWarn !== 'function') {
            ...
            $('#session-timeout-dialog').on('hide.bs.modal', function () {
                ...
                startSessionTimer();
                window.location = opt.continueUrl;
            });
        }
