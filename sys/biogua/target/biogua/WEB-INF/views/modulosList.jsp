...
<%-- 
    Document   : modulosList
    Created on : 07/07/2018, 11:02:16 AM
    Author     : jacosta
--%>
<html>
    <head>
        <title><s:message code="modulosList.titulo" /></title>
    </head>
        ...
        <div class="container">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <s:message code="modulosList.panel"/>
                    </h3>
                </div>
                <div class="card-body">    
                    <div class="myrow" >
                        <div class="col-xs-12 col-sm-12 col-md-2 col-lg-2">
                            <a data-toggle="tooltip" data-placement="left" title="<s:message code="sistema.btnNuevo.tooltip"/>" class="btn btn-info margin-btn"
                               href="<c:url value='/modulos/nuevo'/>">
                                <span  class="fa fa-plus-square"></span>
                                <s:message code="sistema.form.btnNuevo" />
                            </a>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8" >
                            <c:url var='path' value='/modulos'></c:url>                              
                    ...
                    <div class="myrow scrollHorizontal" >
                        <table border='1' cellpadding='1' cellspacing='1'
                            ...
                            <tr class="w3-light-grey">
                                <th><s:message code="modulosList.grilla.descripcion" /></th>
                                <th><s:message code="modulosList.grilla.faIcon" /></th>
                                <th><s:message code="modulosList.grilla.pantallas" /></th>
                            ...
                            <c:forEach items="${lista}" var="l">
                                <tr>
                                    ...
                                    <td class="${l.fa_icon}"><c:out value=" - ${l.fa_icon}" /></td>
                                    <td class="td-center">
                                        <a href="<c:url value='/modulosPantallas/pantallasDelModulo/${l.id}'></c:url>">
                                            <i class="fa fa fa-window-maximize fa-lg " aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title="<s:message code="modulosForm.pantallas.tooltip" />">
                                            </i>
                                        </a>
                                    </td>
                                    <td class="td-center">
